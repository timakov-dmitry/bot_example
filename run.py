...
from modules.vacancies.module import send_vacancy
...
def start(update, context):
    ...
    context.bot.send_message(chat_id=update.effective_chat.id, text="А если напишешь мне 'Вакансия' - я постараюсь найти вакансию твоей мечты в Норбит!")
...
vacancies_handler = MessageHandler(Filters.text(['Вакансия','Вакансии','Вакансии Курск']), send_vacancy)
...
dispatcher.add_handler(vacancies_handler)
