...
bot.register(chose_food_module, ['Что поесть',"Что выбрать поесть","еда","есть","поесть","что выбрать"], "А если напишешь мне '123' - я дам совет по еде!")
bot.register(hackernews_module, ['hackernews',"news","новости","какие новости","что нового"], "А если напишешь мне 'новости' - я расскажу тебе новости!")
